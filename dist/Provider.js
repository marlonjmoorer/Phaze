...
var Provider = function (_Component) {
  ...
  function Provider(props) {
    ...
    _this.actions = store.actions;
    _this.computed = store.computed;
    return _this;
  }
  ...
  _createClass(Provider, [{
    ...
    value: function createState() {
      return _extends({}, this.state, this.actions, this.computed);
    }
  }, {
    key: "render",
...
Provider.propTypes = {
  store: _propTypes2.default.instanceOf(_Store2.default)
};
